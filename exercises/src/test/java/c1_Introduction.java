...
public class c1_Introduction extends IntroductionBase {
    ...
    public void unresponsive_service() {
        Exception exception = assertThrows(IllegalStateException.class, () -> unresponsiveService().block(Duration.ofSeconds(1)));
    ...
    public void leaving_blocking_world_behind() throws InterruptedException {
        ...
        fortuneTop5()
                .subscribe(companyList::add, a -> {}, () -> serviceCallCompleted.set(true));
